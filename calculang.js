...
import * as Babel from 'https://cdn.jsdelivr.net/npm/@babel/standalone/+esm'
...
export const packageCalculang = async (cul) => {

  let compiled = URL.createObjectURL(
    new Blob(
      [compileWithMemo(cul).code],
...
export const bundle = (compiled, introspection) => {
